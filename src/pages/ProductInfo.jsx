import React, { useEffect, useMemo, memo, Suspense, lazy } from "react";
...
export default function ProductInfo() {
  ...
  // ✅ useMemo로 products 캐싱 (렌더마다 배열 재생성 방지)
    ...
    () => [
      {
        ...
        description:
          "컴퓨터안에 있는 전자판.\n부품들이 정보를 주고받을 수 있도록 길을 만들어 주는 역할 수행",
      },
      {
        title: "CPU",
        img: "/cpu.svg",
      ...
      },
      {
        ...
        img: "/power.svg",
        path: "/product/power",
        description: "전기를 컴퓨터 부품이 쓸 수 있게 바꿔서 공급하는 장치",
      },
      {
        title: "케이스",
        img: "/case.svg",
      ...
      <div className="product-grid">
        {products.map((p, i) => (
          <Link to={p.path} key={i} className="product-card">
            {/* ✅ 이미지 lazy load */}
            <LazyImage src={p.img} alt={p.title} />
